  ...
  >
    <source src="/waves.mp4" type="video/mp4" />
         ...
         <div className='bg-gradient-to-r from-[#0b1f24] via-[#0f3d3e] to-[#14532d] h-8 border-white border-y-1  w-full flex justify-between md:flex md:justify-around items-center md:font-bold py-6 px-4 scroll '>
                 ...
                 <div className=' pt-0.95 md:pl-10  '> <div id='animatethree' className=' hover:bg-black hover:text-white text-gray-500   border-black border-2 text-base px-2 py-0.5 rounded-sm font-black'><a href="./about.html">About</a></div></div>
                  <div id='animatefour' className='text-white font-bold   text-base    hover:bg-red-800 hover:text-white hover:border-black hover:border-3 cursor-pointer font-mono  rounded-sm p-0.5 bg-gradient-to-r from-[#0b1f24] via-[#0f3d3e] to-[#14532d] border-2 border-white ' ><a href="./signin.html" >Sign In</a></div>

    ...
    <>
      <div className='flex min-h-screen bg-black  justify-center items-center '>
            ...
            <div className='absolute top-0 p-8'>
                <div id='heading' className='flex text-white font-bold text-2xl' ><div>Currency</div><div>-Converter💱</div></div>
            ...
            <div className=' bg-white min-h-100  rounded-xl w-full sm:w-full md:w-full lg:w-[30%] '>
                <div className='text-center p-6 '><h1 className='text-blue-300 font-bold text-2xl '>CURRENCY CONVERTER</h1></div>
                <div className='flex justify-center'> <hr className='w-[90%]'/></div><br />
                <div className='pt-6 pb-6 pr-7 text-center bg-red-50 font-semibold border-2 border-red-100 rounded-2xl 'id='animate'>AMOUNT:  <label className='bg-white'><input type='number' min={1} className='border-2 border-black rounded-sm'/></label></div>
